...
RSpec.describe NewsReleasesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested news_release as @news_release" do
      news_release = NewsRelease.create! valid_attributes
      get :show, params: {id: news_release.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested news_release as @news_release" do
      news_release = NewsRelease.create! valid_attributes
      get :edit, params: {id: news_release.to_param}, session: valid_session
      expect(assigns(:news_release)).to eq(news_release)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new NewsRelease" do
        expect {
          post :create, params: {news_release: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved news_release as @news_release" do
        post :create, params: {news_release: invalid_attributes}, session: valid_session
        expect(assigns(:news_release)).to be_a_new(NewsRelease)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested news_release" do
        news_release = NewsRelease.create! valid_attributes
        put :update, params: {id: news_release.to_param, news_release: new_attributes}, session: valid_session
        news_release.reload
      ...
      it "assigns the requested news_release as @news_release" do
        news_release = NewsRelease.create! valid_attributes
        put :update, params: {id: news_release.to_param, news_release: valid_attributes}, session: valid_session
        expect(assigns(:news_release)).to eq(news_release)
      end
    ...
    context "with invalid params" do
      it "assigns the news_release as @news_release" do
        news_release = NewsRelease.create! valid_attributes
        put :update, params: {id: news_release.to_param, news_release: invalid_attributes}, session: valid_session
        expect(assigns(:news_release)).to eq(news_release)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested news_release" do
      news_release = NewsRelease.create! valid_attributes
      expect {
        delete :destroy, params: {id: news_release.to_param}, session: valid_session
      }.to change(NewsRelease, :count).by(-1)
    end
